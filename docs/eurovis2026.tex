...
% ---------------------------------------------------------------------------
	...
	\title[GeoImputeVis]{GeoImputeVis: A Visual Analytics Dashboard for Diagnosing Missing Data and Comparing Imputation Methods}
...
\begin{figure*}[tb]
  ...
  \caption{Case Study: The GeoMap highlights the target imputed county and its donors (navy) with opacity indicating contribution weight.}
  % (Bottom) Detailed textual breakdown of the imputation, showing the exact values and weights of the donor counties.
...
\tool bridges the gap between advanced imputation models and interpretable, actionable analytics. Critical design lessons include: (i) preserving algorithm provenance~\cite{Ragan2016}---the UI must reveal why specific donors influence imputations; (ii) aligning visual encodings with epidemiological terminology; and (iii) supporting offline workflows via CSV export.
...
\textsc{Little, R. J., Rubin, D. B.}: \emph{Statistical Analysis with Missing Data}, 3rd edn. Wiley, 2019.

\bibitem{SongSzafir2018}
\textsc{Song, H., Szafir, D. A.}: Where's My Data? Evaluating Visualizations of Missing Data. \emph{IEEE Transactions on Visualization and Computer Graphics} 25(1):914--924, 2019.

\bibitem{Ragan2016}
\textsc{Ragan, E. D., et al.}: Characterizing Provenance in Visualization and Data Analysis: An Organizational Framework of Analytic Approaches. \emph{IEEE Transactions on Visualization and Computer Graphics} 22(1):31--40, 2016.

\bibitem{Endert2017}
\textsc{Endert, A., et al.}: The State of the Art in Integrating Machine Learning into Visual Analytics. \emph{Computer Graphics Forum} 36(8):458--486, 2017.

\bibitem{Gleicher2011}
\textsc{Gleicher, M., et al.}: Visual Comparison for Information Visualization. \emph{Information Visualization} 10(4):289--309, 2011.
